...
5. Prepare o projeto:
   * faça do download do repositório [yii2-app-practical-a](https://github.com/kartik-v/yii2-app-practical-a/archive/master.zip)
   * descompacte o arquivo
   * entre no diretório `yii2-app-practical-a-master/vagrant/config`
