...
5. Prepare project:
   * download repo [yii2-app-practical-a](https://github.com/kartik-v/yii2-app-practical-a/archive/master.zip)
   * unzip it
   * go into directory `yii2-app-practical-a-master/vagrant/config`
